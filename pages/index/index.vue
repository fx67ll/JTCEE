		...
		<view class="login-info">
			<view class="login-card">
				<view class="login-card-head">
					...
					<view class="login-card-head-item" :class="{ 'login-card-head-item-active': !islc, 'login-card-head-item-register': islc }" @click="isLoginCard(false)">注 册</view>
				</view>
				<view class="login-card-content login-card-login" v-if="islc">
					<view class="login-card-content-title">
						登录
					</view>
				</view>
