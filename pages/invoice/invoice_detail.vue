...
export default {
			...
			expressListData: [
				{
					...
					content: '您的快件已签收，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 1
				},
				{
					title: '疑难',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件发生疑难，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 2
				},
				{
					title: '滞留',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件发生滞留，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 3
				},
				{
					title: '超时未签收',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件超时未签收，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 4
				},
				{
					title: '拒签',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件已拒签，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 5
				},
				{
					title: '退回',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件已退回，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 6
				},
				{
					title: '待取件',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件待取件，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 7
				},
				{
					title: '派送中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件派送中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 8
				},
				{
					title: '运输中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件运输中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 9
				},
				{
					title: '清关中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件清关中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 10
				},
				{
					title: '已出库',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件已出库，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 11
				},
				{
					title: '出库中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件出库中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 12
				},
				{
					title: '已揽收',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件已揽收，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 13
				},
				{
					title: '揽收中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件揽收中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 14
				},
				{
					title: '已录单',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件已录单，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 15
				},
				{
					title: '录单中',
					create_time: '2022-06-18 18:06:57',
					content: '您的快件录单中，如有疑问请电联快递员[何瑞瑞， 电话188947473847]。感谢您使用神鹰快递，期待再次为您服务。',
					status: 16
				}
			]
		};
	...
	methods: {
		...
		getOrderQr() {
			let fromType = this.fromType;
			uni.navigateTo({
				url: `/pages/invoice/invoice_qr?fromType=${fromType}`
			});
		}
	}
};
